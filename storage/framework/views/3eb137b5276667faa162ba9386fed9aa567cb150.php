        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              ?>
              <?php if($sale_index_permission_active  || $coupon_permission_active || $delivery_permission_active): ?>
              ...
              <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-export"></i><span><?php echo e(trans('file.Transfer')); ?></span></a>
                <ul id="transfer" class="collapse list-unstyled ">
                  ...
                  ?>
                  <?php if($add_permission_active): ?>
                  <li id="transfer-create-menu"><a href="<?php echo e(route('transfers.create')); ?>"><?php echo e(trans('file.Add Transfer')); ?></a></li>                 <?php endif; ?>
                </ul>
              </li>
              <?php endif; ?>
...
</html><?php /**PATH /home/devup/Desktop/laravel apps/saleproposV2/resources/views/layout/main.blade.php ENDPATH**/ ?>