    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button id="print-btn" type="button" class="btn btn-default btn-sm ml-3 d-none"><i class="dripicons-print"></i> <?php echo e(trans('file.Print')); ?></button>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devup/Desktop/laravel apps/saleproposV2/resources/views/product/index.blade.php ENDPATH**/ ?>