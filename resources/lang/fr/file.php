...
return [
	...
	"Biller List" => "Liste de caissiers",
	"Add Biller" => "Ajouter un caissier",
	...
	"Import Biller" => "importater un caissier",
	"Update Biller" => "Mettre à jour un caissier",
	...
	"Purchased Amount" => "Montant d'achat",
	...
	"Amount" => "",
	"Thank you for shopping with us. Please come again" => "La présence de ce Bon est OBLIGATOIRE lors d'un Avoir, 	Merci",
